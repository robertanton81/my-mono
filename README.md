...
## create mono repo
``` 
$ cd <CREATED PROJECT NAME>
$ nest g app first-app
...
## add library
```
$ nest g library first-lib
```

## use library
#### ./first-app/src/first-app.module.ts
```
...
## add orm
```
$ pnpm i @mikro-orm/core @mikro-orm/nestjs @mikro-orm/sqlite   
```
